...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    ftp: {
      ...
      upload1: {
        files: {
          '/17200/experiments/usatoday/2016/01/election-coloring-book/': 'js/main.js'
        }
      },
      upload2: {
        files: {
          '/17200/experiments/usatoday/2016/01/election-coloring-book/': 'style/project.css'
        }
      },
      upload3: {
        files: {
          '/17200/experiments/usatoday/2016/01/election-coloring-book/': 'data/*.json'
        }
      }
    },
